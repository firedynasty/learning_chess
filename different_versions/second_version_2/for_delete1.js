...
var move_catch = document.getElementById("moveChoice");
move_catch.addEventListener("change", function () {
  console.log('hello world')
  move_var = $("#moveChoice").val()

  console.log(matching_letters[move_var])
   var config = {
        //Spanish Opening
        position: empty_fen[matching_letters[move_var]],
        pieceTheme:
          "https://nothingtoseeheredude.netlify.app/img/chesspieces/wikipedia/{piece}.png",
        draggable: true,
        dropOffBoard: "snapback",
  ...
  board = Chessboard("myBoard", config);
  another_counter = matching_letters[move_var]
})


$("#enter_moves").click( function() {
    console.log('hello world')
     text_val = $( "#move_board" ).val();
    if (text_val.length > 0) {
      if (text_val.includes(",")) {
...
var element = document.getElementById("nextChoice"); //grab the element
element.onclick = function () {
  console.log('hello world')
  another_counter = 0 
  selection_var = 0;
  num_lock_counter = 0 
  $("#Choice").val(parseInt($("#Choice").val()) + 1);
